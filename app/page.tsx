    ...
    <main>
        ...
        <div className="container nav">
          <a className="brand" href="#home" aria-label="Objectif 2033">
            <div className="brand-logo" aria-hidden="true">
              {/* img plutôt que next/image pour éviter d'ajouter une config domains */}
              <img
          ...
          <nav>
            <ul>
              <li>
                <a href="#demo">La démonstration</a>
              </li>
              <li>
                <a href="#themes">Les 7 thèmes</a>
              </li>
              <li>
                <a href="#apo">APOKALYON</a>
              </li>
              <li>
                <a href="#actu">Vidéos</a>
              </li>
            </ul>
          </nav>
        ...
        <div className="container hero-wrap">
          <div>
            <span className="badge">
              🚀 Mouvement mondial • ✨ Conscience • 🕊️ 2033
            </span>
            <h1>
            ...
            <p>
              Notre mission&nbsp;: éclairer la question de la conscience,
              préparer la célébration des 2000 ans en 2033 et fédérer une
              communauté créative (vidéos, défis, NFT, token communautaire{" "}
              <strong>APOKALYON</strong>).
            </p>
            <div className="ctas">
              <a
                className="btn btn-primary"
                ...
                <div className="hero-metric">
                  ...
                  <div>
                    ...
                    <small className="muted">
                      Contenus réguliers pour éveiller et débattre
                    </small>
                  </div>
                  <a href="#actu" aria-label="Voir les vidéos">
                    →
                  </a>
                </div>
                <div className="hero-metric">
                  ...
                  <a href="#apo" aria-label="Découvrir APOKALYON">
                    →
                  </a>
                </div>
                <div className="hero-metric">
                  ...
                  <a href="#roadmap" aria-label="Voir la roadmap">
                    →
                  </a>
                </div>
              </div>
          ...
          <div className="card floaty">
            ...
            <div className="mini-card">
              ...
              <div className="pills">
                <a className="pill" href="#demo">
                  Lire en 3&nbsp;min
                </a>
                <a className="pill" href="#actu">
                  Voir la vidéo
                </a>
              </div>
            </div>
      ...
      <section id="themes">
        <div className="container">
          ...
          <p className="section-desc">
            Un parcours éditorial clair pour comprendre, participer et partager.
          </p>
          ...
          <div className="grid grid-2">
            ...
            <div className="card">
              ...
              <p className="muted small">
                Fonctionnant sur Polygon. Non financier. Utilité communautaire.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="actu">
        <div className="container">
          ...
          <p className="section-desc">
            Derniers contenus «&nbsp;Theos Apokalypsi&nbsp;» et annonces communautaires.
          </p>
          <div className="grid grid-3">
            <article className="card">
              ...
              <a
                className="pill"
                href="https://youtu.be/1PTwTsv1XyU"
                target="_blank"
                rel="noopener"
              >
                Regarder →
        ...
        <div className="container">
          ...
          <div className="timeline">
            <div className="t-item">
              ...
              <p className="section-desc">
                Refonte du site, claims APO, 30 shorts pédagogiques, premiers NFT de collection.
              </p>
            </div>
            <div className="t-item">
              <h3>2027&nbsp;–&nbsp;2030 • Accélération</h3>
              <p className="section-desc">
                Partenariats, manifeste, événements annuels, séries documentaires.
              </p>
            </div>
            <div className="t-item">
              <h3>2031&nbsp;–&nbsp;2033 • Célébration mondiale</h3>
              <p className="section-desc">
                Rassemblement des Pèlerins de 2033, publication finale et engagements.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="contact">
        <div className="container">
          ...
          <p className="section-desc">
            Proposer une collaboration, un témoignage, une idée de vidéo.
          </p>
      ...
      <footer className="footer">
        <div className="container foot">
          <div>
            © {year} Objectif&nbsp;2033 • Un projet par la communauté des
            Pèlerins de&nbsp;2033
          </div>
          <div className="links">
            <a href="https://www.youtube.com/@TheosApokalypsi" target="_blank" rel="noopener">
              YouTube
            </a>
            <a href="https://x.com/miteny" target="_blank" rel="noopener">
              X/Twitter
            </a>
            <a href="https://instagram.com/projet2033" target="_blank" rel="noopener">
              Instagram
            </a>
            <a href="https://dieuexiste.com" target="_blank" rel="noopener">
              dieuexiste.com
            </a>
      ...
      {/* Styles (styled-jsx, aucun setup requis) */}
      <style jsx>{`
        :global(html, body) {
          margin: 0;
          background: #0a1020;
        ...
        .hdr {
          ...
          background: linear-gradient(180deg, rgba(10,16,32,.88), rgba(10,16,32,.55) 60%, transparent);
        ...
        nav a { opacity: .88; padding: 8px 12px; border-radius: 10px; }
        ...
        .btn-primary {
          ...
          color: #08111f; border: none; box-shadow: 0 12px 28px rgba(84,214,255,.25);
        }
        ...
        .hero {
          ...
          background:
            radial-gradient(1200px 600px at 70% 10%, rgba(84,214,255,.12), transparent),
            radial-gradient(1000px 520px at 20% 30%, rgba(124,245,166,.10), transparent),
            linear-gradient(180deg, var(--bg), var(--bg-2));
          border-bottom: 1px solid rgba(255,255,255,.06);
        }
        .hero-wrap {
          display: grid; grid-template-columns: 1.2fr 1fr; gap: 40px; padding: 72px 0 64px; align-items: center;
        }
        .badge { display:inline-flex; gap: 8px; align-items:center; padding: 8px 12px; border-radius: 999px;
          border: 1px solid rgba(255,255,255,.14); background: rgba(255,255,255,.04); color: var(--muted); font-size: 14px; margin: 0 0 12px; }
        h1 { font-size: clamp(36px, 5vw, 56px); line-height: 1.04; margin: 0 0 14px; letter-spacing: .2px;
        ...
        .section-title { font-size: clamp(28px, 4vw, 40px); margin: 0 0 10px; font-family: Georgia, 'Times New Roman', serif; }
        ...
        .timeline::before { content: ""; position: absolute; left: 9px; top: 0; bottom: 0; width: 2px; background: linear-gradient(var(--brand), transparent); }
        .t-item { position: relative; margin: 0 0 24px; }
        .t-item::before { content: ""; position: absolute; left: -2px; top: 2px; width: 12px; height: 12px; border-radius: 50%; background: var(--brand); box-shadow: 0 0 0 4px rgba(84,214,255,.15); }
        :root { --brand: #54d6ff; }
